...
//QPainterPath SmoothCurveGenerator::generateSmoothCurveImp(const QVector<QPointF> &points) {
//    QPainterPath path;
//    int len = points.size();
...
//static QPainterPath SmoothCurveGenerator::generateSmoothCurve(const QPainterPath &basePath, const QVector<QPointF> &points) {
...
//void SmoothCurveGenerator::calculateControlPoints(const QList<QPointF> &knots,
